...
AliasSampler::AliasSampler(std::vector<double>& distribution, const double power) {
    this->build(distribution, power);
}

void AliasSampler::build(std::vector<double>& distribution, const double power) {
