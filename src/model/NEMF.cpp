...
void NEMF::LoadEdgeList(string filename, bool undirect) {
    pnet.LoadEdgeList(filename, undirect);
}

void NEMF::LoadFieldMeta(string filename) {
    pnet.LoadFieldMeta(filename);
}

void NEMF::SaveWeights(string model_name){
...
void NEMF::Train(int sample_times, int walk_steps, double alpha, int workers){
